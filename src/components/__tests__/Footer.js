...
const Footer = () => {
  return (
    ...
    <div className='flex justify-center my-auto mx-2 h-16 gap-5'>
      <Link to='https://play.google.com/store/apps/details?id=in.swiggy.android&hl=en&gl=US&pli=1'><img className='flex justify-center my-auto mx-2 h-16 gap-5' src="https://media-assets.swiggy.com/swiggy/image/upload/fl_lossy,f_auto,q_auto/portal/m/play_store.png" alt="googleplay" /></Link>
      <Link to='https://apps.apple.com/in/app/swiggy-food-grocery-delivery/id989540920'><img className='flex justify-center my-auto mx-2 h-16 gap-5' src="https://media-assets.swiggy.com/swiggy/image/upload/fl_lossy,f_auto,q_auto/portal/m/app_store.png" alt="appstore" /></Link>
    </div>
    </div>
